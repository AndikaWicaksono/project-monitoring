...
export const ACTIVITY_TYPE_META: Record<ActivityType, { color: string; icon: string }> = {
  ...
  monitoring_report_deleted: { color: 'text-pertamina-red', icon: 'trash' },
  ...
  monitoring_sla_deleted: { color: 'text-pertamina-red', icon: 'trash' },
  monitoring_cost_created: { color: 'text-emerald-700', icon: 'plus' },
  monitoring_cost_edited: { color: 'text-amber-700', icon: 'edit' },
  monitoring_cost_deleted: { color: 'text-pertamina-red', icon: 'trash' },
  ...
  monitoring_cost_realization_deleted: { color: 'text-pertamina-red', icon: 'trash' },
  monitoring_bap_created: { color: 'text-emerald-700', icon: 'plus' },
  monitoring_bap_edited: { color: 'text-amber-700', icon: 'edit' },
  monitoring_bap_deleted: { color: 'text-pertamina-red', icon: 'trash' },
}
