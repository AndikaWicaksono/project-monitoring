...
export const ACTIVITY_TYPE_META: Record<ActivityType, { color: string; icon: string }> = {
  ...
  task_deleted: { color: 'text-red-600', icon: 'trash' },
  handoff: { color: 'text-violet-700', icon: 'arrow' },
  team_added: { color: 'text-cyan-700', icon: 'users-plus' },
  team_removed: { color: 'text-red-600', icon: 'users-minus' },
  ...
  user_removed: { color: 'text-red-600', icon: 'user-minus' },
  ...
  handoff_rejected_origin: { color: 'text-red-600', icon: 'x' },
  handoff_confirmed_target: { color: 'text-emerald-700', icon: 'check' },
  handoff_rejected_target: { color: 'text-red-600', icon: 'x' },
  delete_requested: { color: 'text-red-600', icon: 'trash' },
  delete_approved: { color: 'text-red-600', icon: 'trash' },
  ...
  segment_change_rejected: { color: 'text-red-600', icon: 'x' },
  // Monitoring module
  monitoring_report_created: { color: 'text-emerald-700', icon: 'plus' },
  monitoring_report_edited: { color: 'text-amber-700', icon: 'edit' },
  monitoring_report_deleted: { color: 'text-red-600', icon: 'trash' },
  monitoring_report_submitted: { color: 'text-blue-700', icon: 'inbox' },
  monitoring_report_approved: { color: 'text-emerald-700', icon: 'check' },
  monitoring_report_revision: { color: 'text-amber-700', icon: 'edit' },
  monitoring_report_resubmitted: { color: 'text-blue-700', icon: 'arrow' },
  monitoring_sla_created: { color: 'text-emerald-700', icon: 'plus' },
  monitoring_sla_edited: { color: 'text-amber-700', icon: 'edit' },
  monitoring_sla_deleted: { color: 'text-red-600', icon: 'trash' },
  monitoring_cost_created: { color: 'text-emerald-700', icon: 'plus' },
  monitoring_cost_edited: { color: 'text-amber-700', icon: 'edit' },
  monitoring_cost_deleted: { color: 'text-red-600', icon: 'trash' },
  monitoring_cost_realization_created: { color: 'text-emerald-700', icon: 'plus' },
  monitoring_cost_realization_edited: { color: 'text-amber-700', icon: 'edit' },
  monitoring_cost_realization_deleted: { color: 'text-red-600', icon: 'trash' },
  monitoring_bap_created: { color: 'text-emerald-700', icon: 'plus' },
  monitoring_bap_edited: { color: 'text-amber-700', icon: 'edit' },
  monitoring_bap_deleted: { color: 'text-red-600', icon: 'trash' },
}
