...
const DEMO_ACCOUNTS = [
  ...
  { email: 'mekar.fauziah@pertamina.id', password: 'osm123', label: 'Admin OSM — Mekar' },
  { email: 'masyita.mustika@pertamina.id', password: 'osm123', label: 'Admin OSM — Masyita' },
  ...
  { email: 'som1@pertamina.id', password: 'som123', label: 'Site Ops Manager — Fadli' },
  { email: 'som2@pertamina.id', password: 'som123', label: 'Site Ops Manager — Yuni' },
