...
export type ActivityType =
  ...
  // Monitoring module
  | 'monitoring_report_created'
  | 'monitoring_report_edited'
  | 'monitoring_report_deleted'
  | 'monitoring_report_submitted'
  | 'monitoring_report_approved'
  | 'monitoring_report_revision'
  | 'monitoring_report_resubmitted'
  | 'monitoring_sla_created'
  | 'monitoring_sla_edited'
  | 'monitoring_sla_deleted'
  | 'monitoring_cost_created'
  | 'monitoring_cost_edited'
  | 'monitoring_cost_deleted'
  | 'monitoring_cost_realization_created'
  | 'monitoring_cost_realization_edited'
  | 'monitoring_cost_realization_deleted'
  | 'monitoring_bap_created'
  | 'monitoring_bap_edited'
  | 'monitoring_bap_deleted'
