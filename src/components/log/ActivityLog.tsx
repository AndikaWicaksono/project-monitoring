...
const TYPE_LABELS: Record<ActivityType, string> = {
  ...
  // Monitoring module
  monitoring_report_created: 'Laporan Dibuat',
  monitoring_report_edited: 'Laporan Diedit',
  monitoring_report_deleted: 'Laporan Dihapus',
  monitoring_report_submitted: 'Laporan Disubmit',
  monitoring_report_approved: 'Laporan Disetujui',
  monitoring_report_revision: 'Revisi Diminta',
  monitoring_report_resubmitted: 'Laporan Resubmit',
  monitoring_sla_created: 'SLA Dibuat',
  monitoring_sla_edited: 'SLA Diedit',
  monitoring_sla_deleted: 'SLA Dihapus',
  monitoring_cost_created: 'Cost Project Dibuat',
  monitoring_cost_edited: 'Cost Project Diedit',
  monitoring_cost_deleted: 'Cost Project Dihapus',
  monitoring_cost_realization_created: 'Realisasi Dibuat',
  monitoring_cost_realization_edited: 'Realisasi Diedit',
  monitoring_cost_realization_deleted: 'Realisasi Dihapus',
  monitoring_bap_created: 'Dokumen BAP Dibuat',
  monitoring_bap_edited: 'Dokumen BAP Diedit',
  monitoring_bap_deleted: 'Dokumen BAP Dihapus',
}
